        ...
        {role === "Doctor" && (
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-neutral-700 text-white border border-neutral-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 placehneutralr-neutral-400"
              required
            />
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-neutral-600 disabled:teneutraleutral-400"
            >
              Next
            </button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-neutral-700 text-white border border-neutral-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
              required
            >
          ...
          <div className="flex justify-between">
            <button
              onClick={prevStep}
              className="px-4 py-2 bg-neutral-600 teneutraleutral-200 rounded-md hovneutralg-neutral-500 focus:outline-none focus:ring-2 foneutralring-neutral-500"
            >
              Back
            </button>
            <button
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-neutral-700 text-white border border-neutral-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 fineutralg-neutral-600 fneutraltext-neutral-200 honeutralfile:bg-neutral-500"
              required
            />
            {file && (
